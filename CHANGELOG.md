...
## [v1.1.0 (2024-09-06)](https://github.com/risc0/risc0/releases/tag/v1.1.0)
...
* Improve bits of security by removing po2s above 21 from the default verifier parameters. Developers that wish to use po2 22, 23, or 24 may opt-in by using a non-default `VerifierContext`. https://github.com/risc0/risc0/pull/2276
...
* bonsai-sdk: when requesting snark receipts, the successful snark status will provide a receipt URL (in the output field) to download a bincode-encoded `risc0_zkvm::Receipt` with the inner type of `Groth16`. https://github.com/risc0/risc0/pull/2310
